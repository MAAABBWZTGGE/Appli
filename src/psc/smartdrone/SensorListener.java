	...
	public void onSensorChanged(SensorEvent event) {
		try {
			if (event.sensor == mAcceleration) {
				...
				mDataSender.sendPaquet(Paquet.makeAcceleration(event.timestamp, event.values[0], event.values[1], event.values[2]));
				if (mFileWriter != null)
				...
				mDataSender.sendPaquet(Paquet.makeGyroscope(event.timestamp, event.values[0], event.values[1], event.values[2]));
				if (mFileWriter != null)
				...
				mDataSender.sendPaquet(Paquet.makeMagneticField(event.timestamp, event.values[0], event.values[1], event.values[2]));
				if (mFileWriter != null)
				...
				mDataSender.sendPaquet(Paquet.makeOrientation(event.timestamp, event.values[0], event.values[1], event.values[2]));
				if (mFileWriter != null)
